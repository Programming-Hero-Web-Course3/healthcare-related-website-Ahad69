...
const ForeignDoc = ({docs}) => {
    ...
    <div className="foreign p-2">
        <div className="d-flex">
         ...
         <Link to={`/foreigndoctors/${id}`} ><Button className="ms-3 fw-bold mt-4 px-5 py-3 rounded-pill" variant="outline-success">Appoinment</Button></Link>
        </div>
        </div>
    );
};
